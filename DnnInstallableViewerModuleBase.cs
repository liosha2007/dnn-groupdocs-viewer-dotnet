...
namespace DotNetNuke.Modules.DnnInstallableViewer
{
    ...
    /// are accessible to your module's controls (that inherity from DnnInstallableViewerModuleBase
    /// 
    /// </summary>

    public class DnnInstallableViewerModuleBase : DotNetNuke.Entities.Modules.PortalModuleBase
    {
    }
}
